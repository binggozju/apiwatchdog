...
curl -X POST -H "Accept: application/json" -H "Content-type: application/json" -d "{\"apiId\":2, \"callUuid\": \"29A8A151-3821-2D1B-0763-B63728F16D5F\", \"requestTime\":\"2016-10-26 09:23:40\", \"responseTime\":\"2016-10-26 09:23:38\", \"httpReponseCode\":\"200\", \"apiReturnCode\":\"999\", \"sourceService\":\"clientapp\"}" $HOST/collector/collect 2> /dev/null
